...
!(function (t, e) {
  ...
  class Xi extends B {
    ...
    toHtml() {
      const t = document.createElement("div");
      t.innerHTML = this._maybeSanitize(this._config.templateAfandi);
    ...
    _setContent(t, e, i) {
      ...
      n &&
        ((e = this._resolvePossibleFunction(e))
          ? o(e)
            ? this._putElementInTemplateAfandi(r(e), n)
            : this._config.html
    ...
    _putElementInTemplateAfandi(t, e) {
  ...
  class rn extends F {
    constructor(t, e) {
      ...
      super(t, e),
        ...
        (this._activeTrigger = {}),
        (this._popper = null),
        (this._templateAfandiFactory = null),
        (this.tip = null),
        this._setListeners();
    }
    static get Default() {
      ...
      return (
        this.tip ||
          (this.tip = this._createTipElement(
            this._getContentForTemplateAfandi()
          )),
        this.tip
      );
    }
    _createTipElement(t) {
      const e = this._getTemplateAfandiFactory(t).toHtml();
      if (!e) return null;
    ...
    _getTemplateAfandiFactory(t) {
      return (
        this._templateAfandiFactory
          ? this._templateAfandiFactory.changeContent(t)
          : (this._templateAfandiFactory = new Xi({
              ...this._config,
              content: t,
